...
class VehicleID(BaseImageDataset):
    ...
    def __init__(self, root='.', verbose=True,offline_path="", **kwargs):
        ...
        train_path='/home/qianwen.qian/data/data_list/VehicleID/train_viewpoint_3.list'
        gallery_path='/home/qianwen.qian/data/data_list/VehicleID/gallery_viewpoint_10S_2.list'
        query_path='/home/qianwen.qian/data/data_list/VehicleID/test_viewpoint_3.list'
    ...
    def _process_dir(self, list_file, process_type='train'):
        ...
        for res in results:
            ...
            image_id = "/home/qianwen.qian/data/VehicleID_V1.0/image/"+res['portrait_image_url_bak'].split("image/")[-1]
