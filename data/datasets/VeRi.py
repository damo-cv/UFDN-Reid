...
class VeRi(BaseImageDataset):
    ...
    def __init__(self, root='.', verbose=True,offline_path="", **kwargs):
        ...
        train_path='/home/qianwen.qian/data/data_list/VeRi/train_viewpoint2.list'
        test_path='/home/qianwen.qian/data/data_list/VeRi/test_viewpoint2.list'
        query_path='/home/qianwen.qian/data/data_list/VeRi/query_viewpoint2.list'
        ...
        self._process_dir(test_path, process_type='get')

        gallery, num_gallery_pids, num_gallery_imgs, num_gallery_cams, num_gallery_tids  = self._process_dir(test_path, process_type='test')
    ...
    def _process_dir(self, list_file, process_type='train'):
        ...
        for res in results:
            ...
            image_id = "/home/qianwen.qian/data/VeRi/"+res['portrait_image_url_bak'].split("VeRi/")[-1]
