...
class TransReID(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, stride_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, local_feature=False, sie_xishu =1.0,model_path=""):
        super().__init__()
    ...
    def load_param(self, model_path):
        ...
        print("VIT loading pretrained weight successfully")
        # exit()
